 ...
 *Return: 1 first_string and second_string is equal, 0 they are not equal
 */
int _strcmp(const char *first_string, char *second_string)
{
	size_t i = 0;
	...
	if (first_string[i] == '\0' && second_string[i])
		return (0);
	return (1);
}
/**
